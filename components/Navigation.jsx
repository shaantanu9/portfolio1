  ...
  return (
    <nav className="mb-0 w-full">
      <div className="container flex justify-between items-center px-6 py-5 mx-auto md:py-0">
        ...
        >
          <button className="ml-8 px-4 py-1 text-sm text-indigo-700 bg-transparent rounded border border-indigo-700 transition duration-150 ease-in-out focus:outline-none lg:text-lg lg:font-bold focus:ring-2 focus:ring-offset-2 focus:ring-indigo-700 md:block hover:bg-gray-200 sm:px-8 sm:py-3">
            Resume
          </button>
        </a>
      </div>
